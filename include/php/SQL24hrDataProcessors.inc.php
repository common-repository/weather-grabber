...
//Now We Do Low WindChill Temp
	...
	if(($weatherArray['SQLData']['WindChill'][$i] <= $weatherArray['lowWindchill'])&&($weatherArray['SQLData']['WindChill'][$i] != "-17.78")) {
...
//Now We Do High Rain Rate
	...
	if (isset($weatherArray['SQLData']['SolarRadSQL'][$i])) {
	...
	if (isset($weatherArray['SQLData']['UVSQL'][$i])) {
