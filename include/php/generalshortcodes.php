...
function outputFrontpageDisplayFull ($widgetArray,$weatherArray) {
$output = '';
...
$output = $output . '<tr>';
$output = $output . '<th colspan="4" class="tg-center"><span >Sun and Moon</span></th>';
$output = $output . '</tr>';
...
$output = $output . '<td colspan="1" class="tg-center"><span title="Length of Day" >Day Length<br />' . $weatherArray['sunTransit'] . '</span></td>';
...
$output = $output . '<td colspan="1" class="tg-center"><span title="Astronomical Sunrise" >Sunrise<br />' . $weatherArray['astroMarineRiseTime'] . '</span></td>';
$output = $output . '<td colspan="1" class="tg-center"><span title="Astronomical Sunset" >Sunset<br />' . $weatherArray['astroMarineSetTime'] . '</span></td>';
$output = $output . '</tr>';
...
$output = $output . '<td colspan="1" class="tg-center" style="' . '"><span title="Hour Average Wind Speed" >Wind Speed<br />' . $weatherArray['houravgwind'] . ' m/s' .  '</span></td>';
$output = $output . '</tr>';
...
$output = $output . '</tr>';
$output = $output . '<tr>';
$output = $output . '<th colspan="4" class="tg-center">Averages and Trends Since Midnight </th>';
$output = $output . '</tr>';
...
elseif ($atts['wx'] === 'frontpageConditions') {
$output = "OK Front Page Conditions Coming";
$output = outputFrontpageDisplayFull($widgetArray,$weatherArray);
return $output; 
}
